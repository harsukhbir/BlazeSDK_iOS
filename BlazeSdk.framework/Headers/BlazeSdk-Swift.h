...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlazeSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC8BlazeSdk11BlazeClient")
@interface BlazeClient : NSObject
/// Saving BlazeClient instance
///
/// returns:
/// BlazeClient single instance
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDictionary;

SWIFT_PROTOCOL("_TtP8BlazeSdk28BlazeResponseManagerDelegate_")
@protocol BlazeResponseManagerDelegate
- (void)readResponseWithResponse:(NSDictionary * _Nonnull)response;
@end


SWIFT_CLASS("_TtC8BlazeSdk13BlazeSdkClass")
@interface BlazeSdkClass : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8BlazeSdk9CocoaMQTT")
...
@interface CocoaMQTT (SWIFT_EXTENSION(BlazeSdk)) <GCDAsyncSocketDelegate>
...
/// MQTT Delegate
SWIFT_PROTOCOL("_TtP8BlazeSdk17CocoaMQTTDelegate_")
...
/// MQTT Message
SWIFT_CLASS("_TtC8BlazeSdk16CocoaMQTTMessage")
...
/// MQTT Will Message
SWIFT_CLASS("_TtC8BlazeSdk13CocoaMQTTWill")
...
SWIFT_CLASS("_TtC8BlazeSdk15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(BlazeSdk)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BlazeSdk)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BlazeSdk)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BlazeSdk)) <NSURLSessionTaskDelegate>
